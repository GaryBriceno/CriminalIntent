...
import pe.net.lambda.criminalintent.util.PictureUtils;
import pe.net.lambda.criminalintent.CrimeListFragment.Callbacks;
...
public class CrimeFragment extends Fragment {
    ...
    /*
    Interface obligatoria para las activity que albergan fragment
     */
...
//                        DatePickerFragment dialog = new DatePickerFragment();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == REQUEST_DATE){
            ...
            //Especifique para que campo quiere que la consulta devuelva valores
            String[] queryFields = new String[]{
                    ContactsContract.Contacts.DISPLAY_NAME
            };
            //Ejecuta la consulta. La instruccion contactUri funciona aqui como una clausula "where"
            Cursor c = getActivity().getContentResolver().query(contactUri, queryFields, null, null, null);
            try{
                //Compruebe que se han obtenido los resultados
                if(c.getCount() == 0){
                    return;
                }
                //Extraiga la primera columna de la primera fila de datos
                c.moveToFirst();
